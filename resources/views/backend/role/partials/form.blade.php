<div class="row">
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            {!! Form::select('status',[''=>'']+config('backend.status'), null , ['class' => 'form-control select2','id'=>'status','data-placeholder'=>'Select Status','required']) !!}
            <label id="status" class="error" for="status"></label>
        </div>
    </div>
</div>

@if(\Request::route()->getName() == 'admin.role.create')
    <div class="row">
        <div class="col-md-12">
            <fieldset>
